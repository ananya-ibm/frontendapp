...
export const FullWidthTile = styled.div<{ imagePosition: 'left' | 'right'; color?: string; background?: string }>`
  background: ${props => props.background ?? props.theme.colors.backgrounds.panels.primary.base};
  display: grid;
  gap: 2rem;
