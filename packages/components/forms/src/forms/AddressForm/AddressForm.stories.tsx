...
export const Default = args => <AddressForm {...args} />;
Default.args = {};

// ---------------------------------------------------------------------------------------------------

export const WithCountryStateDropdowns = args => <AddressForm {...args} />;
...
export const WithAllFields = args => <AddressForm {...args} />;
WithAllFields.args = {
  ...Default.args,
  fields: [
    'company',
...
export const WithAddressSearch = args => <AddressForm {...args} />;
...
export const WithErrors = args => <AddressForm {...args} />;
WithErrors.args = {
  ...WithCountryStateDropdowns.args,
  data: {
    country: 'US',
...
export const WithCustomFooter = args => <AddressForm {...args} />;
...
export const WithIntl = args => (
  ...
  >
    <AddressForm {...args} intlPrefix="addressForm" />
  </IntlProvider>
);
WithIntl.args = {
  ...WithAllFields.args
...
export const WithCustomValidation = args => <AddressForm {...args} />;
...
export const WithTitleHack = (args) => <AddressForm {...args} />;
WithTitleHack.args = {
  ...Default.args,
  fields: ['title'],
  data: {
