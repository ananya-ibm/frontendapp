...
import { MarketingInfoTabs } from './MarketingInfoTabs';

export default {
  title: 'Components/Automotive/MarketingInfoTabs',
  components: MarketingInfoTabs
};
...
const storyProps = {
  tabs: [
    {
      title: 'Our mission',
      image: '/static/automotive/marketingInfoTabs/tab1image.png',
      description:
    ...
    },
    {
      ...
      image: '/static/automotive/marketingInfoTabs/tab2image.png',
      description:
...
export const normal = args => <MarketingInfoTabs {...args} />;
