...
export default {
  title: 'Features/Account/Profile/Pages/PaymentPage',
...
export const Default = args => (
  <ContainerWrapper app={App} mocks={b2cProfileMock.me()} urlPath="/account-profile/payment">
...
export const Loading = args => (
  <ContainerWrapper
    ...
    urlPath="/account-profile/payment"
    mockState="loading"
  >
    <SessionContextProvider state={{ roles: ['user', 'customer'] }}>
      <PaymentPage {...args} />
