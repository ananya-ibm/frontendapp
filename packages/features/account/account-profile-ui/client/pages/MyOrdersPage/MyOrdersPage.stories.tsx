...
export default {
  title: 'Features/Account/Profile/Pages/MyOrdersPage',
...
export const Default = args => (
  <ContainerWrapper app={App} mocks={b2cProfileMock.me()} urlPath="/account-profile/orders">
...
export const Loading = args => (
  <ContainerWrapper
    ...
    urlPath="/account-profile/orders"
    mockState="loading"
  >
    <SessionContextProvider state={{ roles: ['user', 'customer'] }}>
      <MyOrdersPage {...args} />
