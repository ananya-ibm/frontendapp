...
import App from '../App';
import FinanceConfiguratorPage from './FinanceConfiguratorPage';
import autoCartMocks from '../../mocks/auto-cart';

export default {
  title: 'Features/Automotive/Cart/Containers/FinanceConfiguratorPage',
  component: FinanceConfiguratorPage,
  decorators: [
    Story => (
