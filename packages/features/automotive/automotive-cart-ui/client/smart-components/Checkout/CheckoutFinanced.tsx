...
import { Row, Column, Steps, Step } from '@exo/frontend-components-base';
...
//import FinanceApproval from '../FinanceApproval/FinanceApproval';
import Payment from '../Payment/Payment';
import CreditCheck from '../CreditCheck/CreditCheck';

const CheckoutFinanced = ({ cartId }: Props) => {
      ...
      <Row>
        <Row className="main">
          <Column>
            ...
            {activeStep === 4 && <Confirmation isFinanced />}
          </Column>
...
export default CheckoutFinanced;
