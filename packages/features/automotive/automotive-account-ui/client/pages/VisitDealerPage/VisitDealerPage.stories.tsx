...
import { VisitDealerPage } from './VisitDealerPage';
import App from '../../App';
import autoProfileMock from '../../../mocks/auto-profile';

export default {
  title: 'Features/Automotive/Account/Pages/VisitDealerPage',
  component: VisitDealerPage,
  decorators: [
    Story => {
      return (
...
export const Default = args => (
  <ContainerWrapper
    ...
    urlPath="/account-automotive/visit-dealer"
  >
    <SessionContextProvider state={{ roles: ['user', 'customer'] }}>
      <VisitDealerPage {...args} />
