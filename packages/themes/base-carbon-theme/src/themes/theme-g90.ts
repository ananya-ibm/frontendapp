...
export const g90 = {
  ...
  "button-disabled": "rgba(141, 141, 141, 0.3)",
  "notification-background-error": "var(--cds-layer)",
  "notification-background-success": "var(--cds-layer)",
  "notification-background-info": "var(--cds-layer)",
  "notification-background-warning": "var(--cds-layer)",
  "notification-action-hover": "var(--cds-layer-hover)",
  "notification-action-tertiary-inverse": "#0f62fe",
  "notification-action-tertiary-inverse-active": "#002d9c",
  "notification-action-tertiary-inverse-hover": "#0050e6",
  "notification-action-tertiary-inverse-text": "#ffffff",
  "notification-action-tertiary-inverse-text-on-color-disabled": "#8d8d8d",
